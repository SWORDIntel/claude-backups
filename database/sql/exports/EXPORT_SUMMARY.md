...
**Date**: Fri Sep  5 10:17:25 AM BST 2025  
...
### To Local PostgreSQL
```bash
psql -h localhost -p 5433 -U $USER -d claude_learning < claude_learning_20250905.sql
```
...
git commit -m "backup: Learning data snapshot 20250905"
```
