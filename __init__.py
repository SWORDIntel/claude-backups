...
__description__ = "Hardware-aware multi-agent orchestration system with Tandem Orchestration"
...
try:
    ...
    from agents.src.python.agent_registry import EnhancedAgentRegistry, get_enhanced_registry
...
try:
    ...
    register_with_claude_code = lambda: {"success": False, "error": "Integration not available"}
