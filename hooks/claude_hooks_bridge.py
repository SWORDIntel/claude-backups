...
class ClaudeRegistryBridge:
    ...
    def invoke_agent(self, agent_name: str, task: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def _try_python_invocation(self, agent_name: str, task: str, context: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """Try to invoke agent through Python import"""
        try:
            # Check for cluster direct implementations
            if agent_name in ["constructor", "patcher", "testbed", "linter", "debugger"]:
    ...
    def _try_subprocess_invocation(self, agent_name: str, task: str, context: Dict[str, Any]) -> Optional[Dict[str, Any]]:
...
def main():
    ...
    parser.add_argument('command', choices=['list', 'invoke', 'refresh', 'info', 'categories'],
