...
from intelligent_context_chopper import ContextChunk, IntelligentContextChopper
...
class ContextChoppingHookManager:
    ...
    def __init__(self, db_connection_string: str = None):
        ...
        self.enabled = True
        self.debug_mode = (
            os.environ.get("CONTEXT_CHOPPER_DEBUG", "false").lower() == "true"
        )
    ...
    def pre_commit_hook(
        self, repo_path: str, files_changed: List[str]
    ) -> Dict[str, Any]:
        """
    ...
    def pre_request_hook(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.debug_mode:
                print(
                    f"Context optimized: {original_tokens} -> {request_data['optimized_context_tokens']} tokens"
                )
    ...
    def post_response_hook(
        ...
        try:
            ...
            rejection_avoided = (
                "optimized_context_tokens" in request_data
                and success
                and request_data["original_context_tokens"] > 8000
            )
                ...
                for chunk in chunks:
                    ...
                    """,
                        (
                            ...
                            self._detect_language(chunk.file_path),
    ...
    def _update_learning_feedback(
        self, query: str, context: str, success: bool, rejection_avoided: bool
    ):
...
def claude_post_response_hook(
    response_data: Dict[str, Any], request_data: Dict[str, Any]
) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test-precommit", action="store_true", help="Test pre-commit hook"
    )
