...
class DeploymentDashboard:
    ...
    async def check_system_health(self) -> Dict[str, Any]:
        ...
        health_status["components"]["learning_system"] = await self._check_learning_system()
    ...
    async def _check_docker_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if postgres_status.returncode == 0 and "healthy" in postgres_status.stdout.lower():
                return {
                    "status": "healthy",
    ...
    async def _check_database_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            async with self.db_pool.acquire() as conn:
                ...
                expected_tables = ['agent_metrics', 'task_embeddings', 'interaction_logs', 
                                 'learning_feedback', 'model_performance']
    ...
    async def validate_deployment(self) -> Dict[str, Any]:
        ...
        try:
            wrapper_path = Path.home() / "claude-backups" / "claude-wrapper-ultimate.sh"
            test_cmd = ["bash", "-c", f"source {wrapper_path} && type capture_execution"]
        ...
        validation_results["summary"] = {
            ...
            "passed_tests": sum(1 for test in validation_results["tests"].values() if test["passed"]),
            "failed_tests": sum(1 for test in validation_results["tests"].values() if not test["passed"])
        }
