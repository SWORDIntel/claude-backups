...
class DynamicAgentRegistry:
    ...
    def _create_agent_info(self, agent_file: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            description = self._generate_description(
                agent_file.stem, category, metadata
            )
    ...
    def _extract_metadata_from_content(self, content: str) -> Dict:
        ...
        for line in lines:
            ...
            # Look for description patterns
                ...
                for keyword in ["specialist", "expert", "manager", "developer"]
            ):
    ...
    def _generate_aliases(self, file_stem: str) -> List[str]:
        ...
        if "-" in file_stem:
            ...
            camel_case = "".join(
                ...
                for i, part in enumerate(file_stem.split("-"))
            )
    ...
    def _generate_description(
        self, file_stem: str, category: str, metadata: Dict
    ) -> str:
    ...
    def create_registry(self) -> Dict[str, Any]:
        ...
        try:
            if (
                self.cache_registry_file.exists()
                or self.cache_registry_file.is_symlink()
            ):
