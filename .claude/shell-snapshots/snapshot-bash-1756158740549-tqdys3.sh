...
export PATH=/home/ubuntu/.local/bin\:/home/ubuntu/.npm-global/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin\:/snap/bin
