...
async def create_configuration_files():
    ...
    trigger_config = {
        ...
        'priority_rules': [
            {
                'condition': 'critical',
                'priority': ['director', 'security', 'monitor']
            },
            {
                'condition': 'urgent',
...
async def run_integration_test():
    ...
    try:
        ...
        try:
            ...
            logger.info(f"  - Requests processed: {stats['pipeline_metrics']['requests_processed']}")
...
async def main():
    ...
    try:
        ...
        if integration_success:
            ...
            logger.warning("⚠️ Setup completed with warnings - check integration test results")
