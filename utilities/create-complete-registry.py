    ...
    for agent_name in sorted(agent_files):
        ...
        agent_info = {
            ...
            "description": agent_metadata.get(
                "description", f"{agent_name} specialist"
            ),
...
def determine_category(agent_name):
    ...
    # Command & Control
        ...
        word in name_lower
        for word in ["director", "orchestrator", "planner", "cso", "oversight"]
    ):
        return "command"
    ...
    elif "internal" in name_lower or any(
        word in name_lower
        for word in [
            "python",
            "java",
    ...
    # Platforms
        ...
        word in name_lower
        for word in ["web", "mobile", "android", "gui", "tui", "pygui"]
    ):
        return "platforms"
    ...
    # Data & ML
        ...
        word in name_lower
        for word in ["datascience", "mlops", "database", "researcher"]
    ):
        return "data"
    ...
    # Hardware
        ...
        word in name_lower
        for word in ["npu", "gna", "leadengineer", "hardware", "optimizer"]
    ):
        return "hardware"
