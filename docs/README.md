...
**🎯 Penetration Testers**
- [Quick Start](installation/quick-start.md) → [Basic Usage](guides/basic-usage.md) → [OPSEC Best Practices](guides/opsec-best-practices.md)

**🔬 Security Researchers**
- [Enhanced DNS Features](features/dns-enhanced.md) → [Advanced Techniques](guides/advanced-techniques.md) → [API Reference](api/)

**💻 Developers**
- [Compilation Instructions](installation/compilation.md) → [API Reference](api/) → [Plugin Interface](api/plugin-interface.md)

**🏢 Enterprise Users**
- [Platform Support](installation/platform-support.md) → [Performance Tuning](guides/performance-tuning.md) → [Docker Deployment](installation/docker.md)
...
**⚠️ Important**: Obtain proper authorization before testing third-party systems. Follow all applicable laws and regulations. Respect rate limits and terms of service.
