...
agent_template:
  ...
  invokes_agents:
    frequently:
      - DataScience    # Model preparation
      - MLOps          # Deployment pipeline
      - Optimizer      # Performance tuning
    as_needed:
      - Monitor        # Inference metrics
      - Python-Internal # Model conversion
  ...
  communication:
    ...
    tandem_execution:
      supported_modes:
        ...
        - SPEED_CRITICAL  # Binary layer for NPU ops
      ...
      python_implementation:
        module: "agents.src.python.npu_impl"
      ...
      c_implementation:
        binary: "src/c/npu_agent"
        shared_lib: "libnpu.so"
        capabilities:
          - "Direct NPU access"
          - "DMA operations"
