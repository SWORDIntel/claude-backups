/*
 * WEB AGENT - Communication System Integration
...
// Initialize agent
int web_init(web_agent_t* agent) {
    // Initialize communication context
    agent->comm_context = ufp_create_context("web");
    ...
    agent_register("web", AGENT_TYPE_WEB, NULL, 0);
    
    return 0;
}

// Process incoming message
int web_process_message(web_agent_t* agent, ufp_message_t* msg) {
    // TODO: Implement agent-specific logic
    printf("Web received message from %s\n", msg->source);
