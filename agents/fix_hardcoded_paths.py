...
class HardcodedPathFixer:
    def __init__(self, agents_dir):
        ...
        self.path_replacements = [
            ...
            (r'${CLAUDE_AGENTS_ROOT:-$(dirname "$0")}/../', '${CLAUDE_AGENTS_ROOT:-$(dirname "$0")}/../'),
            (r'${CLAUDE_AGENTS_ROOT:-$(dirname "$0")}/../', '${CLAUDE_AGENTS_ROOT:-$(dirname "$0")}/../'),
            (r'/home/(ubuntu|john)/[^/]+/claude-backups/agents/', '${CLAUDE_AGENTS_ROOT:-$(dirname "$0")}/../'),

            # Project root paths
            (r'${CLAUDE_PROJECT_ROOT:-$(dirname "$0")/../../}', '${CLAUDE_PROJECT_ROOT:-$(dirname "$0")/../../}'),
            (r'${CLAUDE_PROJECT_ROOT:-$(dirname "$0")/../../}', '${CLAUDE_PROJECT_ROOT:-$(dirname "$0")/../../}'),
            (r'/home/(ubuntu|john)/[^/]+/claude-backups/', '${CLAUDE_PROJECT_ROOT:-$(dirname "$0")/../../}'),
            ...
            (r'${OPENVINO_ROOT:-/opt/openvino/}', '${OPENVINO_ROOT:-${OPENVINO_ROOT:-/opt/openvino/}}'),
            (r'${CLAUDE_LOG_DIR:-/var/log/claude-agents/}', '${CLAUDE_LOG_DIR:-${CLAUDE_LOG_DIR:-/var/log/claude-agents/}}'),
        ]
        ...
        self.python_replacements = [
            ...
            (r"os.path.join(os.environ.get('CLAUDE_AGENTS_ROOT', '.'), 'config', '$1')]+)'", "os.path.join(os.environ.get('CLAUDE_AGENTS_ROOT', '.'), 'config', '$1')"),
            (r'os.path.join(os.environ.get("CLAUDE_AGENTS_ROOT", "."), "config", "$1")]+)"', 'os.path.join(os.environ.get("CLAUDE_AGENTS_ROOT", "."), "config", "$1")'),
        ]
    ...
    def fix_c_files(self):
        ...
        c_files = list(self.agents_dir.rglob('*.c')) + list(self.agents_dir.rglob('*.h'))
    ...
    def fix_config_files(self):
        ...
        config_files = (list(self.agents_dir.rglob('*.json')) +
        ...
        for config_file in config_files:
            try:
                ...
                fixed_content, changed = self.fix_file_content(str(config_file), content)
