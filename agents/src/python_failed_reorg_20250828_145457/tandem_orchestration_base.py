...
class PerformanceProfiler:
    ...
    def get_metrics(self) -> MetricsSnapshot:
        ...
        avg_execution_time = sum(self.execution_times) / len(self.execution_times) if self.execution_times else 0.0
    ...
    def get_percentiles(self, percentiles: List[int] = [50, 75, 90, 95, 99]) -> Dict[str, float]:
...
class TandemOrchestrationBase:
    ...
    def __init__(self, agent_name: str, orchestrator_bridge: Optional[OrchestratorBridge] = None):
    ...
    async def execute_with_orchestration(self, command: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def delegate_to_agent(self, target_agent: str, task_spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.orchestrator_bridge.request_delegation(target_agent, task)
    ...
    async def send_inter_agent_message(self, target_agent: str, message_type: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Send message to another agent"""
    ...
    def _register_message_handlers(self):
        ...
        self.message_queue.register_handler('delegation', self._handle_delegation_message)
        self.message_queue.register_handler('health_check', self._handle_health_check_message)
        self.message_queue.register_handler('metrics_request', self._handle_metrics_request_message)
