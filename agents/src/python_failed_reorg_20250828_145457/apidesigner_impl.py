...
class APIDESIGNERPythonExecutor:
    ...
    async def design_rest_api(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        await self._create_apidesigner_files(result, context if 'context' in locals() else {})
        return {
            'status': 'success',
            'api_type': 'REST',
...
# Example usage
    ...
    async def _create_apidesigner_files(self, result_data: Dict[str, Any], context: Dict[str, Any]):
...
'''
            ...
            print(f"APIDESIGNER files created successfully in {main_dir} and {docs_dir}")
