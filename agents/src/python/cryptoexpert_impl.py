...
class CRYPTOEXPERTPythonExecutor:
    ...
    async def _audit_crypto_config(self) -> Dict[str, Any]:
        ...
        await self._create_cryptoexpert_files(result, context if 'context' in locals() else {})
...
# Example usage and testing
    ...
    async def _create_cryptoexpert_files(self, result_data: Dict[str, Any], context: Dict[str, Any]):
...
'''
            ...
            print(f"CRYPTOEXPERT files created successfully in {main_dir} and {docs_dir}")
