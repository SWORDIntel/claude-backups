...
def get_all_agents():
    ...
    for md_file in agents_dir.glob("*.md"):
        if md_file.name not in ["Template.md", "Agents Readme.md", "WHERE_I_AM.md", "TEMPLATE.md"]:
...
def main():
    ...
    critical_agents = [
        'architect', 'constructor', 'debugger', 'deployer', 'infrastructure',
        'linter', 'patcher', 'packager', 'oversight', 'bastion', 'tui',
        'researcher', 'planner'
    ]
    ...
    categories = {
        ...
        'Security': ['bastion', 'oversight', 'cryptoexpert', 'cso', 'securityauditor', 
                    'securitychaosagent', 'redteamorchestrator'],
        'UI/Interface': ['tui', 'androidmobile'],
        'Planning': ['planner', 'researcher', 'qadirector', 'leadengineer'],
        'System': ['c-internal', 'python-internal', 'gna', 'npu', 'statusline_integration'],
