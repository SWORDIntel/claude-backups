...
"""
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        await self._create_testbed_files(result, context if 'context' in locals() else {})
        return {
    ...
    async def _create_testbed_files(self, result_data: Dict[str, Any], context: Dict[str, Any]):
