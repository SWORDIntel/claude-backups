...
try:
    from claude_agents.learning.postgresql_learning_system import UltimatePostgreSQLLearningSystem, AgentTaskExecution, TaskContext
    from claude_agents.learning.learning_orchestrator_bridge import EnhancedLearningOrchestrator, LearningStrategy, ExecutionContext
    IMPORTS_AVAILABLE = True
    ULTIMATE_SYSTEM_AVAILABLE = True
except ImportError:
    try:
        from claude_agents.learning.postgresql_learning_system import PostgreSQLLearningSystem, AgentTaskExecution
        from claude_agents.learning.learning_orchestrator_bridge import EnhancedLearningOrchestrator, LearningStrategy, ExecutionContext
        IMPORTS_AVAILABLE = True
