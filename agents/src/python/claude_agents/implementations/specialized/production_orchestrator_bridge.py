...
try:
    from claude_agents.orchestration.agent_registry import AgentMetadata as AgentInfo
    from claude_agents.orchestration.agent_registry import (
        EnhancedAgentRegistry as AgentRegistry,
    )
...
from claude_agents.orchestration.tandem_orchestration_base import AgentTask
