...
try:
    from claude_agents.orchestration.production_orchestrator import ProductionOrchestrator, CommandStep, CommandSet, ExecutionMode
    from claude_agents.orchestration.agent_registry import EnhancedAgentRegistry as AgentRegistry, AgentMetadata as AgentInfo
