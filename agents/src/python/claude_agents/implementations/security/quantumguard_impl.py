...
class QUANTUMGUARDPythonExecutor:
    ...
    async def _kyber_operations(self, operation: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        await self._create_quantumguard_files(result, context if 'context' in locals() else {})
        return {
...
async def main():
    ...
    async def _create_quantumguard_files(self, result_data: Dict[str, Any], context: Dict[str, Any]):
...
'''
            ...
            print(f"QUANTUMGUARD files created successfully in {main_dir} and {docs_dir}")
