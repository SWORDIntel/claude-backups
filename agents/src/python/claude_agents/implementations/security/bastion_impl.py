...
class BASTIONPythonExecutor:
    ...
    async def _handle_hardening_command(self, args: List[str], context: Dict) -> Dict[str, Any]:
        ...
        await self._create_bastion_files(result, context if 'context' in locals() else {})
        return {
            "status": "success",
            "scope": scope,
            "level": level,
...
class ComplianceEngine:
    ...
    async def _create_bastion_files(self, result_data: Dict[str, Any], context: Dict[str, Any]):
