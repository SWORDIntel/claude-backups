...
try:
    ...
    from claude_agents.implementations.specialized.production_orchestrator_bridge import create_orchestrator_bridge
...
class EnhancedAgentWrapper(TandemOrchestrationBase):
    ...
    def __init__(self, original_agent: Any, agent_name: str, bridge_mode: str = "production"):
        ...
        try:
            ...
            try:
                from claude_agents.orchestration.tandem_orchestration_base import MockOrchestratorBridge
    ...
    def _define_capabilities(self) -> Dict[str, Any]:
        ...
        base_capabilities = {
            ...
            'supports_parallel_execution': self.agent_config.get('parallel_execution', True),
...
def enhance_agent(original_agent: Any, agent_name: str, bridge_mode: str = "production") -> EnhancedAgentWrapper:
...
def with_orchestration(agent_name: str, bridge_mode: str = "production"):
    ...
    def decorator(cls: Type) -> Type:
        ...
        def new_init(self, *args, **kwargs):
            ...
            self.execute_with_orchestration = self._orchestration.execute_with_orchestration
...
async def enhance_all_existing_agents(agent_directory: Path, bridge_mode: str = "production") -> Dict[str, EnhancedAgentWrapper]:
...
class OrchestrationManager:
    ...
    async def initialize(self, agent_directory: Optional[Path] = None):
        ...
        self.enhanced_agents = await enhance_all_existing_agents(agent_directory, self.bridge_mode)
        self.is_running = True
        
        logger.info(f"Orchestration manager initialized with {len(self.enhanced_agents)} agents")
    ...
    async def get_system_metrics(self) -> Dict[str, Any]:
        ...
        system_metrics = {
            ...
            'running_agents': sum(1 for agent in self.enhanced_agents.values() if agent.is_running),
            'agents': {},
    ...
    async def execute_on_agent(self, agent_name: str, command: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def delegate_task(self, source_agent: str, target_agent: str, task_spec: Dict[str, Any]) -> Dict[str, Any]:
...
async def get_orchestration_manager(bridge_mode: str = "production") -> OrchestrationManager:
